...
clean_pathme = 's3://{}:{}@{}/{}'.format('AKIATAQZ5MYPWP5OFBEN', 'xDLzNS84BEGhC7mrMPta+zPAOHMmfE14baleyKQ/', BUCKET_NAME, data_key_clean)
cleanall = pd.read_csv(smart_open(clean_pathme))

netclean_pathme = 's3://{}:{}@{}/{}'.format('AKIATAQZ5MYPWP5OFBEN', 'xDLzNS84BEGhC7mrMPta+zPAOHMmfE14baleyKQ/', BUCKET_NAME, data_key_netclean)
netflixexplain = pd.read_csv(smart_open(netclean_pathme))

hulclean_pathme = 's3://{}:{}@{}/{}'.format('AKIATAQZ5MYPWP5OFBEN', 'xDLzNS84BEGhC7mrMPta+zPAOHMmfE14baleyKQ/', BUCKET_NAME, data_key_hulclean)
huluexplain = pd.read_csv(smart_open(hulclean_pathme))

tubiclean_pathme = 's3://{}:{}@{}/{}'.format('AKIATAQZ5MYPWP5OFBEN', 'xDLzNS84BEGhC7mrMPta+zPAOHMmfE14baleyKQ/', BUCKET_NAME, data_key_tubclean)
